function [timebase, chA, chB, chC, chD] = pico_averaged_waveform3(device, numAvg, acquisitionLength, interval, maxSamples)
    ...
    [numSamples,~,chA, chB, chC, chD] = invoke(rapidBlockGroupObj, 'getRapidBlockData', numAvg-1, downsamplingRatio, downsamplingRatioMode);
